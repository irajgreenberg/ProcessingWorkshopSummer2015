boolean Start(int cB) {
  ...
  */
  text("Level: ", 200, 100);
  int avg = (abs(rect1x1)+abs(rect1y1)+abs(rect2y1)+abs(rect3y1)+abs(rect4y1)+abs(rect2x1)+abs(rect3x1)+abs(rect4x1)/8*25);
  float level = avg/(speed*0.25);
  text("" + nf(level,2,1), 300, 100);
